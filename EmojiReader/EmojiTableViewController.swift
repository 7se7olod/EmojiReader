...
class EmojiTableViewController: UITableViewController {
    ...
    var objects = [
        Emoji(emoji: "🧠", name: "Brain", description: "You must have brain!", isFavourite: false),
        Emoji(emoji: "🦷", name: "Tooth", description: "You have healthy teeth!", isFavourite: false),
        Emoji(emoji: "👰🏼", name: "Wife", description: "She will be you wife!", isFavourite: false)
